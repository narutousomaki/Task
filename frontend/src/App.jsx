...
function App() {
  ...
  const fetchTasks = async () => {
    try {
      const res = await axios.get(" https://task-icf9.onrender.com/tasks");
      setTasks(res.data);
    } catch (error) {
      console.log(error);
    }
  ...
  const addTask = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        " https://task-icf9.onrender.com/tasks",
        newTask
      );
  ...
  const deleteTask = async (id) => {
    try {
      await axios.delete(` https://task-icf9.onrender.com/tasks/${id}`);
